...
data class OwnCloudCredentials(
...
@Singleton
class OwnCloudAuthManager @Inject constructor(
    ...
    fun saveCredentials(accountId: String, credentials: OwnCloudCredentials) {
        prefs.edit()
    ...
    fun getCredentials(accountId: String): OwnCloudCredentials? {
        ...
        return OwnCloudCredentials(url, user, pass)
    }

...
@Singleton
class NextcloudAuthManager @Inject constructor(
    ...
    fun saveCredentials(accountId: String, credentials: NextcloudCredentials) {
        prefs.edit()
    ...
    fun getCredentials(accountId: String): NextcloudCredentials? {
        ...
        return NextcloudCredentials(url, user, pass)
    }
